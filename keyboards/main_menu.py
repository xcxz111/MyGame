...
def main_menu_keyboard(
    ...
    *,
    ...
    if show_kmb:
        builder.add(InlineKeyboardButton(text=t("btn_kmb", lang), callback_data="menu:kmb"))
    if show_checkers:
        builder.add(InlineKeyboardButton(text=t("btn_checkers", lang), callback_data="menu:checkers"))
    if show_slot:
